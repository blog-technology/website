...
insert into categories (id,name,status,path,resource_key,icon,sequence,type,parent) values
 ...
 ('bcp-drp','BCP - DRP','A','/bcp-drp','bcp_drp','zoom_in',30,'','concept'),

 ('layer-architecture','Layer Architecture','A','/layer-architecture','layer_architecture','zoom_in',1,'','design'),
 ('hexagonal-architecture','Hexagonal Architecture','A','/hexagonal-architecture','hexagonal_architecture','zoom_in',2,'','design'),
 ('clean-architecture','Clean Architecture','A','/clean-architecture','clean_architecture','zoom_in',3,'','design'),
 ('onion-architecture','Onion Architecture','A','/onion-architecture','onion_architecture','zoom_in',4,'','design'),
 ('soa','Service Oriented Architecture (SOA)','A','/soa','soa','zoom_in',6,'','design'),
 ('microservices','Microservices','A','/microservices','microservices','assignment',7,'','design'),
 ('cqrs','CQRS Architecture','A','/cqrs','cqrs','credit_card',8,'','design'),
 ('event-driven-architecture','Event Driven Architecture','A','/event-driven-architecture','event_driven_architecture','mail',9,'','design'),
 ...
 ('cross-site-scripting','Cross-Site Scripting (XSS)','A','/cross-site-scripting','cross_site_scripting','assignment',7,'','security'),
 ('cross-site-request-forgery','Cross-Site Request Forgery (CSRF)','A','/cross-site-request-forgery','cross_site_request_forgery','assignment',8,'','security'),
 ('file-inclusion','File Inclusion','A','/file-inclusion','file_inclusion','assignment',9,'','security'),
 ('ddos','DDoS Attack','A','/ddos','ddos','assignment',10,'','security'),
 ('ransomware-attack','Ransomware Attack','A','/ransomware-attack','ransomware_attack','credit_card',11,'','security'),
 ('malware-virus-trojan-worms','Malware, Virus, Trojan, Worms','A','/malware-virus-trojan-worms','malware_virus_trojan_worms','credit_card',12,'','security'),
 ('mac-dac','MAC - DAC','A','/mac-dac','mac_dac','credit_card',13,'','security'),
 ('rbac','Role-Based Access Control (RBAC)','A','/rbac','rbac','assignment',14,'','security'),
 ('maker-checker','Maker/Checker','A','/maker-checker','maker_checker','assignment',15,'','security'),
