...
insert into categories (id,name,status,path,resource_key,icon,sequence,type,parent) values
 ...
 ('rto-rpo-drp','RTO - RPO - DRP','A','/rto-rpo-drp','rto_rpo_drp','assignment',4,'','concept'),
 ('business-continuity-plan','Business Continuity Plan','A','/business-continuity-plan','business_continuity_plan','assignment',5,'','concept'),
 
 ('reverse-proxy','Reverse Proxy','A','/reverse-proxy','reverse_proxy','assignment',6,'','concept'),
 ('ldap','LDAP','A','/ldap','ldap','assignment',7,'','concept'),
 ('orm','ORM','A','/orm','orm','assignment',8,'','concept'),
 ('message-queue','Message Queue','A','/message-queue','message_queue','assignment',9,'','concept'),
 ('devops','DevOps','A','/devops','devops','assignment',10,'','concept'),
 ('devsecops','DevSecOps','A','/devsecops','devsecops','assignment',11,'','concept'),
 ('cloud','Cloud','A','/cloud','cloud','assignment',12,'','concept'),
 ('cms','CMS','A','/cms','cms','assignment',13,'','concept'),

 ('layer-architecture','Layer Architecture','A','/layer-architecture','layer_architecture','settings',1,'','architecture'),
 ('hexagonal-architecture','Hexagonal Architecture','A','/hexagonal-architecture','hexagonal_architecture','settings',2,'','architecture'),
 ('onion-architecture','Onion Architecture','A','/onion-architecture','onion_architecture','settings',3,'','architecture'),
 ('clean-architecture','Clean Architecture','A','/clean-architecture','clean_architecture','settings',4,'','architecture'),
 ('service-oriented-architecture','Service Oriented Architecture (SOA)','A','/service-oriented-architecture','service_oriented_architecture','settings',5,'','architecture'),
 ('microservices-architecture','Microservices Architecture','A','/microservices-architecture','microservices_architecture','settings',6,'','architecture'),
 ('cqrs-architecture','CQRS Architecture','A','/cqrs-architecture','cqrs_architecture','settings',7,'','architecture'),
 ...
 ('sql-injection','SQL Injection','A','/sql-injection','sql_injection','assignment',1,'','security'),
 ('waf-hips-fim-protection','WAF, HIPS, FIM Protection','A','/waf-hips-fim-protection','waf_hips_fim_protection','assignment',2,'','security'),
 ('cross-site-scripting','Cross-Site Scripting (XSS)','A','/cross-site-scripting','cross_site_scripting','assignment',3,'','security'),
 ('cross-site-request-forgery','Cross-Site Request Forgery (CSRF)','A','/cross-site-request-forgery','cross_site_request_forgery','assignment',4,'','security'),
 ('remote-file-inclusion','Remote File Inclusion (RFI)','A','/remote-file-inclusion','remote_file_inclusion','assignment',5,'','security'),
 ...
 ('malware-virus-trojan-worms','Malware, Virus, Trojan, Worms','A','/malware-virus-trojan-worms','malware_virus_trojan_worms','assignment',8,'','security'),
