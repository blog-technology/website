...
insert into categories (id,name,status,path,resource_key,icon,sequence,type,parent) values
 ...
 ('orm','ORM','A','/orm','orm','assignment',6,'','concept'),
 ('devops','Devops','A','/devops','devops','assignment',7,'','concept'),
 ('cloud','Cloud','A','/cloud','cloud','assignment',8,'','concept'),

 ('waf','WAF','A','/security','waf','assignment',1,'','security'),
 ('hips','HIPS','A','/security','hips','assignment',2,'','security'),
 ('fim','FIM','A','/security','fim','assignment',3,'','security'),

 ('node_data_validation','Node Data Validation','A','/node-data-validation','node_data_validation','assignment',1,'','node'),
 ('node_export_data','Node Export Data','A','/node-export-data','node_export_data','assignment',2,'','node'),
 ('node_import_data','Node Import Data','A','/node-import-data','node_import_data','assignment',3,'','node'),
 ('node_sql','Node SQL','A','/node-sql','node_sql','assignment',4,'','node'),
 ('node_mongo','Node MongoDB','A','/node-mongo','node_mongo','assignment',5,'','node'),
 ('express_sql_orm','Express SQL','A','/express-sql','express_sql','assignment',6,'','node'),
 ('express_mongo','Express MongoDB','A','/express-mongo','express_mongo','assignment',7,'','node'),

 ('go_data_validation','Go Data Validation','A','/go-data-validation','go_data_validation','assignment',1,'','go'),
 ('go_export_data','Go Export Data','A','/go-export-data','go_export_data','assignment',2,'','go'),
 ('go_import_data','Go Import Data','A','/go-import-data','go_import_data','assignment',3,'','go'),
 ('go_sql','Go SQL','A','/go-sql','go_sql','assignment',4,'','go'),
 ('go_sql_orm','Go ORM','A','/go-sql-orm','go_sql_orm','assignment',5,'','go'),
 ('go_mongo','Go Mongo','A','/go-mongo','go_mongo','assignment',6,'','go'),
 ('go_rest_api','Go REST API','A','/go-rest-api','go_rest_api','assignment',7,'','go'),
 ('go_grpc','GRPC','A','/go-grpc','go_grpc','assignment',8,'','go'),
