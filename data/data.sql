...
insert into categories (id,name,status,path,resource_key,icon,sequence,type,parent) values
 ...
 ('bcp-drp','BCP - DRP','A','/bcp-drp','bcp_drp','assignment',0,'','concept'),
 ...
 ('devops','DevOps','A','/devops','devops','assignment',6,'','concept'),
 ('devsecops','DevSecOps','A','/devsecops','devsecops','assignment',7,'','concept'),
 ('ldap','LDAP','A','/ldap','ldap','assignment',8,'','concept'),
 ('orm','ORM','A','/orm','orm','assignment',9,'','concept'),
 ('cdn','CDN','A','/cdn','cdn','mail',10,'','concept'),
 ('message-queue','Message Queue','A','/message-queue','message_queue','assignment',11,'','concept'),
 ('cms','CMS','A','/cms','cms','assignment',12,'','concept'),
 ('forward-proxy','Forward Proxy','A','/forward-proxy','forward_proxy','assignment',13,'','concept'),
 ('reverse-proxy','Reverse Proxy','A','/reverse-proxy','reverse_proxy','assignment',14,'','concept'),
