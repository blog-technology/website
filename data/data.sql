...
insert into categories (id,name,status,path,resource_key,icon,sequence,type,parent) values
 ...
 ('cluster','Cluster','A','/cluster','cluster','settings',1,'','concept'),
 ('docker','Docker','A','/docker','docker','mail',2,'','concept'),
 ('kubernetes','Kubernetes','A','/kubernetes','kubernetes','assignment',3,'','concept'),
 ('rto_rpo_drp','RTO - RPO - DRP','A','/rto-rpo-drp','rto_rpo_drp','assignment',4,'','concept'),
 ('business_continuity_plan','Business Continuity Plan','A','/business-continuity-plan','business_continuity_plan','assignment',5,'','concept'),
 
 ('reverse_proxy','Reverse Proxy','A','/reverse-proxy','reverse_proxy','assignment',6,'','concept'),
 ('ldap','LDAP','A','/ldap','ldap','assignment',7,'','concept'),
 ('orm','ORM','A','/orm','orm','assignment',8,'','concept'),
 ('devops','DevOps','A','/devops','devops','assignment',9,'','concept'),
 ('devsecops','DevSecOps','A','/devsecops','devsecops','assignment',10,'','concept'),
 ('cloud','Cloud','A','/cloud','cloud','assignment',11,'','concept'),
 ('cms','CMS','A','/cms','cms','assignment',12,'','concept'),

 ('layer_architecture','Layer Architecture','A','/layer-architecture','layer_architecture','settings',1,'','architecture'),
 ('microservices_architecture','Microservices Architecture','A','/microservices-architecture','microservices_architecture','settings',2,'','architecture'),
 ('event_driven_architecture','Event Driven Architecture','A','/event-driven-architecture','event_driven_architecture','settings',3,'','architecture'),
 ('hexagonal_architecture','Hexagonal Architecture','A','/hexagonal-architecture','hexagonal_architecture','settings',4,'','architecture'),
 ('clean_architecture','Clean Architecture','A','/clean-architecture','clean_architecture','settings',5,'','architecture'),
 ('serverless_architecture','Serverless Architecture','A','/serverless-architecture','serverless_architecture','settings',6,'','architecture'),

 ('sql_injection','SQL Injection','A','/sql-injection','sql_injection','assignment',1,'','security'),
 ('waf_hips_fim_protection','WAF, HIPS, FIM Protection','A','/waf-hips-fim-protection','waf_hips_fim_protection','assignment',2,'','security'),
 ('cross-site-scripting','Cross-Site Scripting (XSS)','A','/cross-site-scripting','cross_site_scripting','assignment',3,'','security'),
 ('cross_site_request_forgery','Cross-Site Request Forgery (CSRF)','A','/cross-site-request-forgery','cross_site_request_forgery','assignment',4,'','security'),
 ('remote_file_inclusion','Remote File Inclusion (RFI)','A','/remote-file-inclusion','remote_file_inclusion','assignment',5,'','security'),
 ('ddos','DDoS Attack','A','/ddos','ddos','assignment',6,'','security'),
 ('ransomware','Ransomware Attack','A','/ransomware','ransomware','assignment',7,'','security'),
 ('malware_virus_trojan_worms','Malware, Virus, Trojan, Worms','A','/malware-virus-trojan-worms','malware_virus_trojan_worms','assignment',8,'','security'),

 ('node_project_layout','Node Project Layout','A','/node-project-layout','node_project_layout','assignment',1,'','node'),
 ('node_interview_questions','Node Interview Questions','A','/node-interview-questions','node_interview_questions','assignment',2,'','node'),
 ('node_developer_roadmap','Node Developer Roadmap','A','/node-developer-roadmap','node_developer_roadmap','assignment',3,'','node'),
 ('node_data_validation','Node Data Validation','A','/node-data-validation','node_data_validation','assignment',4,'','node'),
 ('node_export_data','Node Export Data','A','/node-export-data','node_export_data','assignment',5,'','node'),
 ('node_import_data','Node Import Data','A','/node-import-data','node_import_data','assignment',6,'','node'),
 ('node_sql','Node SQL','A','/node-sql','node_sql','assignment',7,'','node'),
 ('node_mongo','Node MongoDB','A','/node-mongo','node_mongo','assignment',8,'','node'),
 ('express_sql_orm','Express SQL','A','/express-sql','express_sql','assignment',9,'','node'),
 ('express_mongo','Express MongoDB','A','/express-mongo','express_mongo','assignment',10,'','node'),

 ('go_syntax','Go Syntax','A','/go-syntax','go_syntax','assignment',1,'','go'),
 ('go_developer_roadmap','Go Developer Roadmap','A','/go-developer-roadmap','go_developer_roadmap','assignment',2,'','go'),
 ('go_interview_questions','Go Interview Questions','A','/go-interview-questions','go_interview_questions','assignment',3,'','go'),
 ('go_project_layout','Go Project Layout','A','/go-project-layout','go_project_layout','assignment',4,'','go'),
 ('go_data_validation','Go Data Validation','A','/go-data-validation','go_data_validation','assignment',5,'','go'),
 ('go_export_data','Go Export Data','A','/go-export-data','go_export_data','assignment',6,'','go'),
 ('go_import_data','Go Import Data','A','/go-import-data','go_import_data','assignment',7,'','go'),
 ('go_sql','Go SQL','A','/go-sql','go_sql','assignment',8,'','go'),
 ('go_sql_orm','Go ORM','A','/go-sql-orm','go_sql_orm','assignment',9,'','go'),
 ('go_mongo','Go Mongo','A','/go-mongo','go_mongo','assignment',10,'','go'),
 ('go_rest_api','Go REST API','A','/go-rest-api','go_rest_api','assignment',11,'','go'),
 ('go_grpc','GRPC','A','/go-grpc','go_grpc','assignment',12,'','go'),
