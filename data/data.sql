...
insert into categories (id,name,status,path,resource_key,icon,sequence,type,parent) values
 ...
 ('design','Design','A','/architecture','design','settings',2,'content',''),
 ('security','Security','A','/security','security','settings',3,'content',''),
 ('go','Golang','A','/go','go','credit_card',4,'',''),
 ('node','node','A','/node','node','credit_card',5,'',''),
 ('frontend','Frontend','A','/frontend','frontend','work',6,'',''),

 ('cluster','Cluster','A','/cluster','cluster','zoom_in',1,'','concept'),
 ('virtual-machine','Virtual Machine','A','/virtual-machine','virtual_machine','zoom_in',2,'','concept'),
 ('docker','Docker','A','/docker','docker','credit_card',3,'','concept'),
 ('kubernetes','Kubernetes','A','/kubernetes','kubernetes','credit_card',4,'','concept'),
 ('cicd','CI/CD','A','/cicd','cicd','zoom_in',5,'','concept'),
 ('devops','DevOps','A','/devops','devops','credit_card',6,'','concept'),
 ('devsecops','DevSecOps','A','/devsecops','devsecops','credit_card',7,'','concept'),
 ('ldap','LDAP','A','/ldap','ldap','zoom_in',8,'','concept'),
 ('orm','ORM','A','/orm','orm','assignment',9,'','concept'),
 ('cdn','CDN','A','/cdn','cdn','zoom_in',10,'','concept'),
 ('message-queue','Message Queue','A','/message-queue','message_queue','mail',11,'','concept'),
 ('forward-proxy','Forward Proxy','A','/forward-proxy','forward_proxy','zoom_in',12,'','concept'),
 ('reverse-proxy','Reverse Proxy','A','/reverse-proxy','reverse_proxy','zoom_in',13,'','concept'),
 ('bcp-drp','BCP - DRP','A','/bcp-drp','bcp_drp','zoom_in',20,'','concept'),

 ('serverless','Serverless','A','/serverless','serverless','zoom_in',1,'','design'),
 ('soa','Service Oriented Architecture (SOA)','A','/soa','soa','zoom_in',2,'','design'),
 ('microservices','Microservices','A','/microservices','microservices','assignment',3,'','design'),
 ('cqrs','CQRS Architecture','A','/cqrs','cqrs','credit_card',4,'','design'),
 ('event-driven-architecture','Event Driven Architecture','A','/event-driven-architecture','event_driven_architecture','mail',5,'','design'),
 ('event-sourcing-architecture','Event Sourcing Architecture','A','/event-sourcing-architecture','event_sourcing_architecture','credit_card',6,'','design'), 
 ('microkernel-architecture','Microkernel Architecture','A','/microkernel-architecture','microkernel_architecture','credit_card',7,'','design'),

 ('owasp','OWASP','A','/owasp','owasp','credit_card',1,'','security'),
 ('waf-hips-fim','WAF, HIPS, FIM Protection','A','/waf-hips-fim','waf_hips_fim_protection','credit_card',2,'','security'),
 ('hardening-va-scan-pentest','Hardening Scan - VA Scan - Pentest','A','/hardening-va-scan-pentest','waf_hips_fim_protection','credit_card',3,'','security'),
 ...
 ('ransomware-attack','Ransomware Attack','A','/ransomware-attack','ransomware_attack','credit_card',9,'','security'),
 ('malware-virus-trojan-worms','Malware, Virus, Trojan, Worms','A','/malware-virus-trojan-worms','malware_virus_trojan_worms','credit_card',10,'','security'),
 ('mac-dac','MAC - DAC','A','/mac-dac','mac_dac','credit_card',11,'','security'),
 ...
 ('go-syntax','Go Syntax','A','/go-syntax','go_syntax','credit_card',1,'','go'),
 ('go-developer-roadmap','Go Developer Roadmap','A','/go-developer-roadmap','go_developer_roadmap','credit_card',2,'','go'),
 ('go-interview-questions','Go Interview Questions','A','/go-interview-questions','go_interview_questions','credit_card',3,'','go'),
