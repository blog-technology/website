...
insert into categories (id,name,status,path,resource_key,icon,sequence,type,parent) values
 ...
 ('node','node','A','/node','node','credit_card',4,'',''),
 ('frontend','Frontend','A','/frontend','frontend','work',5,'',''),
 ('go','Golang','A','/go','go','mail',6,'',''),
 ...
 ('reverse_proxy','Reverse Proxy','A','/reverse-proxy','reverse_proxy','assignment',5,'','concept'),
 ('ldap','LDAP','A','/ldap','ldap','assignment',6,'','concept'),
 ('orm','ORM','A','/orm','orm','assignment',7,'','concept'),
 ('devops','Devops','A','/devops','devops','assignment',8,'','concept'),
 ('cloud','Cloud','A','/cloud','cloud','assignment',9,'','concept'),
 ...
 ('go_developer_roadmap','Go Developer Roadmap','A','/go-developer-roadmap','go_developer_roadmap','assignment',1,'','go'),
 ('go_interview_questions','Go Interview Questions','A','/go-interview-questions','go_interview_questions','assignment',1,'','go'),
 ('go_project_layout','Go Project Layout','A','/go-project-layout','go_project_layout','assignment',2,'','go'),
 ('go_data_validation','Go Data Validation','A','/go-data-validation','go_data_validation','assignment',3,'','go'),
 ('go_export_data','Go Export Data','A','/go-export-data','go_export_data','assignment',4,'','go'),
 ('go_import_data','Go Import Data','A','/go-import-data','go_import_data','assignment',5,'','go'),
 ('go_sql','Go SQL','A','/go-sql','go_sql','assignment',6,'','go'),
 ('go_sql_orm','Go ORM','A','/go-sql-orm','go_sql_orm','assignment',7,'','go'),
 ('go_mongo','Go Mongo','A','/go-mongo','go_mongo','assignment',8,'','go'),
 ('go_rest_api','Go REST API','A','/go-rest-api','go_rest_api','assignment',9,'','go'),
 ('go_grpc','GRPC','A','/go-grpc','go_grpc','assignment',10,'','go'),
